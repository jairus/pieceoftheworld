<?php
	...
	*/
	...
	$receiptData['txnId'] = $_POST['txn_id'];	
	$receiptData['purchaseDate'] = $_POST['payment_date'];		
	$receiptData['totalAmount'] = $_POST['mc_gross'];			
	$receiptData['buyerEmail'] = $useremail;	
	$receiptData['landTitle'] = $post['title_name'];	
	$receiptData['landDetail'] = $post['detail_name'];	
	...
	if($land[0]['land_special_id']){
		...
		$receiptData['landId'] = $land[0]['land_detail_id'];
